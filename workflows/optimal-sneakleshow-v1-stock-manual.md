...
WRITING FOR SPEECH
Short and medium sentences. Concrete nouns. Strong verbs. Occasional fragments. Natural emphasis.
...
Each one must feel heavier than the last. Make the next question emerge from what was just discovered,
rather than announcing "now let's move to the next point".
...
OUTPUT
CRITIQUE
All 16 gates with PASS/FAIL, evidence and the required fix.
